...
import HOSTELMANAGEMENTSYSTEM2.AdminDashboard;
          ...
          try (PreparedStatement preparedStatement = connection.prepareStatement(checkUserQuery)) {
            ...
            if (resultSet.next()) {
              ...
              if (storedPassword.equals(enteredPassword)) {
                ...
                login.this.dispose(); // Use App.this.dispose() to refer to the outer JFrame
                System.out.println("Login window closed"); // Debug statement

                // Open the Main window
                SwingUtilities.invokeLater(() -> {
                  AdminDashboard AdminDashboardWindow = new AdminDashboard();
                  AdminDashboardWindow.setVisible(true);
                  System.out.println("AdminDashboard window opened"); // Debug statement
                });
              } else {
